...
function setSentMessageMap() {
    ...
    sentMessageMap.put("011", new Array());
    sentMessageMap.put("012", new Array());
    sentMessageMap.put("013", new Array());
    sentMessageMap.put("014", new Array());
    sentMessageMap.put("02", new Array());
}
